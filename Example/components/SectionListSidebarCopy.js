...
export default class SectionListSidebar extends React.PureComponent {
  ...
  renderSectionHeader = ({section}) => {
    ...
    return (
      <Text style={{...sectionHeaderTextStyle, height: sectionHeaderHeight}}>
        {section.title}
      </Text>
    );
  };
  ...
  renderSidebarItem =
    this.props.renderSidebarItem || this.renderDefaultSidebarItem;
  ...
  render() {
    const {data, rtl, containerStyle, sidebarContainerStyle, ...props} =
      this.props;
